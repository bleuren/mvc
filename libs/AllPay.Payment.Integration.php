...
class AllInOne
{
    ...
    public function __construct()
    {
        ...
        $this->Send = array('ReturnURL' => '', 'ClientBackURL' => '', 'OrderResultURL' => '', 'MerchantTradeNo' => '', 'MerchantTradeDate' => '', 'PaymentType' => 'aio', 'TotalAmount' => '', 'TradeDesc' => '', 'ChoosePayment' => PaymentMethod::ALL, 'Remark' => '', 'ChooseSubPayment' => PaymentMethodItem::None, 'NeedExtraPaidInfo' => ExtraPaymentInfo::No, 'DeviceSource' => '', 'IgnorePayment' => '', 'PlatformID' => '', 'InvoiceMark' => InvoiceState::No, 'Items' => array(), 'EncryptType' => EncryptType::ENC_MD5, 'UseRedeem' => UseRedeem::No);
        $this->SendExtend = array();
        $this->Query = array('MerchantTradeNo' => '', 'TimeStamp' => '');
        $this->Action = array('MerchantTradeNo' => '', 'TradeNo' => '', 'Action' => ActionType::C, 'TotalAmount' => 0);
        $this->ChargeBack = array('MerchantTradeNo' => '', 'TradeNo' => '', 'ChargeBackTotalAmount' => 0, 'Remark' => '');
        $this->Capture = array();
    }
    //產生訂單
...
{
    abstract public function check_goods($arParameters = array());
    abstract public function filter_string($arExtend = array(), $InvoiceMark = '');
    abstract public function check_extend_string($arExtend = array(), $InvoiceMark = '');
    // 電子發票延伸參數。
    public $arInvoice = array('RelateNumber', 'CustomerIdentifier', 'CarruerType', 'CustomerID', 'Donation', 'Print', 'TaxType', 'CustomerName', 'CustomerAddr', 'CustomerPhone', 'CustomerEmail', 'ClearanceMark', 'CarruerNum', 'LoveCode', 'InvoiceRemark', 'DelayDay', 'InvoiceItemName', 'InvoiceItemCount', 'InvoiceItemWord', 'InvoiceItemPrice', 'InvoiceItemTaxType', 'InvType');
    //檢查共同參數
    ...
    public function check_invoiceString($arExtend = array())
    {
        ...
        $encode_fields = array('CustomerName', 'CustomerAddr', 'CustomerEmail', 'InvoiceItemName', 'InvoiceItemWord', 'InvoiceRemark');
...
{
    public $arPayMentExtend = array('Desc_1' => '', 'Desc_2' => '', 'Desc_3' => '', 'Desc_4' => '', 'PaymentInfoURL' => '', 'ClientRedirectURL' => '', 'StoreExpireDate' => '');
    //檢查共同參數
    public function check_string($arParameters = array())
    {
...
{
    public $arPayMentExtend = array('ExpireDate' => 3, 'PaymentInfoURL' => '', 'ClientRedirectURL' => '');
    //檢查共同參數
    public function check_string($arParameters = array())
    {
        parent::check_string($arParameters);
...
{
    public $arPayMentExtend = array('Email' => '', 'PhoneNo' => '', 'UserName' => '', 'AlipayItemName' => '', 'AlipayItemCounts' => '', 'AlipayItemPrice' => '');
    //檢查共同參數
    public function check_string($arParameters = array())
    {
        parent::check_string($arParameters);
...
{
    public $arPayMentExtend = array('CreditInstallment' => 0, 'InstallmentAmount' => 0, 'Redeem' => false, 'UnionPay' => false, 'Language' => '', 'PeriodAmount' => '', 'PeriodType' => '', 'Frequency' => '', 'ExecTimes' => '', 'PeriodReturnURL' => '');
    //檢查共同參數
    public function check_string($arParameters = array())
    {
        parent::check_string($arParameters);
