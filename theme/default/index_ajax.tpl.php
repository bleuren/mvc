...
<div id="container" class="boxed-page">
	...
	<div class="navbar navbar-default navbar-top">
		<div class="container">
			...
			<div class="navbar-collapse collapse pjax">
				<!-- Stat Search -->
		...
		<ul class="wpb-mobile-menu">
			<?php foreach ($this->menu as $i => $v): ?>
			<?php if (empty($v->sub)): ?>
			<li><a class="pjax" href="<?php if (!empty($v->url)): ?><?php echo $v->url; ?><?php else:?>
			index.php?mod=pages&act=show&id=<?php echo $v->id; ?><?php endif; ?>
			"><?php echo $v->name; ?></a></li>
			<?php else: ?>
			<li><a class="pjax" href="<?php if (!empty($v->url)): ?><?php echo $v->url; ?><?php else:?>
			...
			<ul class="dropdown">
				<?php foreach ($v->sub as $j => $k): ?>
				<li><a class="pjax" href="<?php if (!empty($k->url)): ?><?php echo $k->url; ?><?php else:?>index.php?mod=pages&act=show&id=<?php echo $k->id; ?><?php endif; ?>"><?php echo $k->name; ?></a></li>
				<?php endforeach; ?>
			</ul>
			</li>
			<?php endif; ?>
			...
			<div class="row blog-page">
				...
				<div class="col-md-3 sidebar left-sidebar">
					...
					<div class="widget widget-categories">
						<h4>一般選項 <span class="head-line"></span></h4>
						<ul>
					...
					<div class="widget widget-categories">
						<h4>使用者選項 <span class="head-line"></span></h4>
						<ul>
							<?php if (!isset($_SESSION['user'])): ?>
                            <li><a href="index.php?mod=users">用戶登入</a></li>
							<?php else: ?>
							<li>
	...
	<div class="container">
		...
		<div class="copyright-section">
			<div class="row">
				<div class="col-md-6">
					<p>
						本網站強烈不支援IE瀏覽器，請改用Firefox或其他瀏覽器
					</p>
				</div>
				<div class="col-md-6">
					<ul class="footer-nav">
						<li><a href="mailto:paste.ren@gmail.com">&copy; 2016 Jia-Huei, Ren - All Rights Reserved</a></li>
					</ul>
				</div>
			</div>
		</div>
...
<script type="text/javascript" src="theme/default/js/script.min.js"></script>
</body>
</html>